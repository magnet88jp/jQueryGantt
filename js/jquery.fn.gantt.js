...
(function ($, undefined) {
    ...
    $.fn.gantt = function (options) {
        ...
        var core = {
            ...
            createProgressBar: function (days, label, desc, classNames, dataObj, dayHref) {
                label = label || "";
                label = (dayHref) ? '<a href="' + dayHref + '" >' + label + '</a>' : label;
                    ...
                    if (i >= element.pageNum * settings.itemsPerPage &&
                        ...
                        $.each(entry.values, function (j, day) {
                            ...
                            case "hours":
                                ...
                                _bar = core.createProgressBar(dl, day.label, day.desc, day.customClass, day.dataObj, day.href);
